...
const mockContent = [
  ...
  },
  {
    ...
    summary:
      "Comprehensive guide to genetic screening tests, their importance, and what to expect during the process.",
  ...
  },
  {
    ...
    summary:
      "Explore how genetic factors influence cardiovascular health and preventive measures for your family.",
  ...
  },
  {
    ...
    summary:
      "Evidence-based strategies to reduce risk and promote health in families with genetic predispositions.",
    category: "Prevention",
    reading_time: 5,
    is_featured: false,
    image_url: null,
  },
  {
    ...
    summary:
      "Important considerations for family planning when genetic conditions are present in your family history.",
  ...
  },
  {
    ...
    summary:
      "The critical role of early screening and detection in managing hereditary health conditions.",
    category: "Prevention",
    reading_time: 4,
    is_featured: false,
    image_url: null,
      ...
      <div className="awareness-hub-container">
        ...
        <div className="awareness-hub-header">
          ...
          <p className="awareness-hub-subtitle">
            Learn about hereditary health and prevention
          </p>
        </div>
                  ...
                  <div key={item.id} className="featured-card">
                    ...
                    <div className="card-header">
                      <div className="card-header-content">
                        ...
                        <span
                          className={`category-badge ${getCategoryColor(item.category)}`}
                        >
                          {item.category}
                        </span>
                      </div>
